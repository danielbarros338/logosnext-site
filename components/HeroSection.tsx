...
const HeroSection = () => {
  return (
    <section
      id="inicio"
      className="min-h-[calc(100vh+200px)] md:min-h-screen flex items-center pt-16 relative overflow-hidden"
    >
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-16">
          <div className="w-full lg:w-7/12 xl:w-3/5">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 text-pretty">
              Consultoria especializada em automação de processos, integração de
              sistemas e soluções sob medida em tecnologia para pequenas e
              médias empresas que buscam eficiência e crescimento.
            </p>
          ...
          <div className="w-full lg:w-5/12 xl:w-2/5 flex justify-center lg:justify-end">
            <Image
              ...
              width={640}
              height={640}
              style={{ width: "min(90vw, 420px)", height: "auto" }}
              sizes="(max-width: 640px) 90vw, (max-width: 1024px) 70vw, 420px"
              className="drop-shadow-[0_20px_60px_rgba(52,245,197,0.25)]"
              priority
              fetchPriority="high"
              placeholder="empty"
            />
